...
- Verification: 5 automated tests pass on Python 3.14.4; included risky and safe examples produce the expected JSON findings and no findings, respectively. GitHub release `v0.1.0` is public and contains the wheel and source archive.
- Next: monitor the first CI run, then maintain issues and release follow-up fixes as needed.
